...
{
    public partial class drugfrom : Form
    {
        ...
        private void drugfrom_Load(object sender, EventArgs e)
        {
    ...
    private void RefreshStockDataGrid()
        {
        ...
        private void textBoxAddedBy_SelectedIndexChanged(object sender, EventArgs e)
        {
